...
- **Avance 2026-09-11:** relaciones físicas completadas para usuarios, auditoría, cuentas bancarias, catálogo, inventario, producción, calidad, comercial, finanzas de clientes y procure-to-pay (47 tablas en cinco migraciones). Véanse los documentos `docs/integridad-fk-empresa-*.md`. El ítem permanece abierto hasta cubrir los demás dominios.
