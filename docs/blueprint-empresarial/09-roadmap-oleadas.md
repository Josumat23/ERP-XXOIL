...
- **Avance 2026-09-11:** relaciones físicas completadas para usuarios, auditoría, cuentas bancarias, catálogo, inventario, producción, calidad, comercial, finanzas de clientes, procure-to-pay, tesorería/series de documento, configuración/contabilidad general, costos/activos/proyectos, centros de trabajo/mantenimiento/proyecciones y RR. HH./asistencia/planilla/adjuntos (76 tablas en diez migraciones). Véanse los documentos `docs/integridad-fk-empresa-*.md`. El ítem permanece abierto hasta cubrir los demás dominios.
