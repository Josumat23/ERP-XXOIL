...
- **Avance 2026-09-11:** relaciones físicas completadas para usuarios, auditoría, cuentas bancarias, catálogo, inventario, producción, calidad, comercial, finanzas de clientes, procure-to-pay, tesorería/series de documento y configuración/contabilidad general (59 tablas en siete migraciones). Véanse los documentos `docs/integridad-fk-empresa-*.md`. El ítem permanece abierto hasta cubrir los demás dominios.
