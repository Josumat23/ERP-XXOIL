...
- **Avance 2026-09-10:** relaciones físicas completadas para usuarios, auditoría, cuentas bancarias, catálogo, inventario, producción y calidad (18 tablas en dos migraciones). Véanse `docs/integridad-fk-empresa-catalogo-inventario.md` y `docs/integridad-fk-empresa-produccion-calidad.md`. El ítem permanece abierto hasta cubrir los demás dominios.
