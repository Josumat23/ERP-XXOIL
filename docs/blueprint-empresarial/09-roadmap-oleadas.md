...
- **Avance 2026-09-11:** relaciones físicas completadas para usuarios, auditoría, cuentas bancarias, catálogo, inventario, producción, calidad y núcleo comercial (25 tablas en tres migraciones). Véanse `docs/integridad-fk-empresa-catalogo-inventario.md`, `docs/integridad-fk-empresa-produccion-calidad.md` y `docs/integridad-fk-empresa-comercial.md`. El ítem permanece abierto hasta cubrir los demás dominios.
