...
- **§7 — Escalamiento de cobranza**: ~~`AvisoCobranza` sigue siendo un log de avisos emitidos, sin máquina de estados.~~ — **la mitad no ambigua se cerró el 2026-09-12**: el aviso ya registra la respuesta del cliente y el compromiso de pago, y un compromiso vencido con la factura impaga se marca solo. Falta el escalamiento automático, que es política de cobranza. Véase `docs/seguimiento-cobranza.md`.
