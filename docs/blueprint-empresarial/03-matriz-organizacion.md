...
| Segmento de crédito | Parcial | **Parcial, con menos brecha**: límite, bloqueo, auditoría del cambio, aprobación del pedido que lo excede, **aprobación del cambio de límite** (el aumento no se aplica hasta resolverse) y **seguimiento del aviso de cobranza** con compromiso de pago e incumplimiento derivado, y **escalamiento automático de cobranza** configurable por compañía, los tres del 2026-09-12. Pendiente: el nivel posterior al aviso final (cobranza judicial) y el segmento compartido entre compañías |
