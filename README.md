...
| **Configuración del Sistema** | Empresa (membrete + IGV + montos de aprobación de compras/pagos + tasas de financiamiento), usuarios, series de documentos SUNAT con correlativo sugerido, almacenes y zonas, unidades de medida, grupos de seguridad (referencia), calendario fiscal con cierre de períodos que bloquea la contabilización |
