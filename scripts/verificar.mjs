...
// proyecto. Si el servidor de desarrollo los estaba escribiendo —o se lo
// interrumpió a medias— quedan truncados y `tsc` falla señalando un archivo
// que nadie escribió. CI nunca los tiene, así que borrarlos es parecerse más a
// CI, no menos. Next los regenera cuando hagan falta.
