  ...
  return (
    <form action={formAction} className="flex flex-col gap-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <input name="nombre" required aria-label="Nombre del contacto" placeholder="Nombre" className="campo-input text-sm" />
        <input name="cargo" aria-label="Cargo del contacto" placeholder="Cargo (opcional)" className="campo-input text-sm" />
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <input name="telefono" aria-label="Teléfono del contacto" placeholder="Teléfono" className="campo-input text-sm" />
        <input name="email" type="email" aria-label="Correo del contacto" placeholder="Correo" className="campo-input text-sm" />
      </div>
      ...
      <p aria-live="polite" className="sr-only">{enviando ? "Agregando contacto" : ""}</p>
    </form>
  );
}
