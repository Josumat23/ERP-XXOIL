...
export const MODULOS: Modulo[] = [
  {
    ...
    enlaces: [
      ...
      { href: "/proyecciones", etiqueta: "Proyecciones", roles: ["ADMIN", "GERENCIA", "VENTAS", "PRODUCCION"] },
  ...
  },
  {
    ...
    enlaces: [
      ...
      { href: "/comercial/equivalentes", etiqueta: "Buscar equivalente" },
    ...
    grupos: [
      {
        ...
        enlaces: [
          ...
          { href: "/catalogo/especificaciones", etiqueta: "Especificaciones técnicas" },
          { href: "/catalogo/competencia", etiqueta: "Productos de la competencia" },
      ...
      },
      {
        ...
        enlaces: [
          ...
          { href: "/logistica/oleadas-picking", etiqueta: "Picking por oleadas" },
          { href: "/logistica/unidades-manipulacion", etiqueta: "Unidades de manipulación" },
          { href: "/logistica/transportistas", etiqueta: "Transportistas" },
          { href: "/logistica/licitaciones-flete", etiqueta: "Licitaciones de flete" },
  ...
  },
  {
    ...
    enlaces: [
      ...
      { href: "/produccion/calidad/reensayos", etiqueta: "Qué reensayar" },
      ...
      { href: "/produccion/mantenimiento/ubicaciones", etiqueta: "Ubicaciones técnicas" },
  ...
  },
  {
    ...
    enlaces: [
      ...
      { href: "/rrhh/organigrama", etiqueta: "Organigrama", roles: ["ADMIN", "GERENCIA"] },
      { href: "/rrhh/posiciones", etiqueta: "Posiciones organizativas", roles: ["ADMIN", "GERENCIA"] },
      ...
      { href: "/rrhh/asistencia/indicadores", etiqueta: "Indicadores de asistencia", roles: ["ADMIN", "GERENCIA"] },
  ...
  },
  {
    ...
    enlaces: [
      ...
      { href: "/configuracion/cobranza", etiqueta: "Escalamiento de cobranza", roles: ["ADMIN"] },
