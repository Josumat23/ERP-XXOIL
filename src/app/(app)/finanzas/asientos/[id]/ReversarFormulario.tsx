...
import { reversarAsiento, type EstadoFormulario } from "../actions";

export default function ReversarFormulario({ asientoId }: { asientoId: string }) {
  const accion = reversarAsiento.bind(null, asientoId);
  ...
  return (
    <form action={formAction} className="flex flex-wrap items-end gap-3">
      ...
      >
        {enviando ? "Reversando..." : "Reversar asiento"}
      </button>
    </form>
  );
}
