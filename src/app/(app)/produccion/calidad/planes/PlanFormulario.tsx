...
type Fila = { nombre: string; unidadMedida: string; limiteInferior: string; limiteSuperior: string; metodoEnsayo: string; obligatoria: boolean; esDensidad: boolean };
const nuevaFila = (): Fila => ({ nombre: "", unidadMedida: "", limiteInferior: "", limiteSuperior: "", metodoEnsayo: "", obligatoria: true, esDensidad: false });
